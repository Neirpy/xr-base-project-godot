...
The goal of this project is to provide a pre-configured environment to save you time and let you focus entirely on creation. This README is structured step-by-step so you can easily understand the project architecture without having to ask many questions.
...
> * **Malcolm Nixon** (Creator of Godot XR Tools)
> * **Bastiaan Olij** (Lead maintainer of Godot's XR architecture)
> * **Brackeys** (For Godot basics)
...
* Use an **XRController3D** node (depends on if you want hand tracking or not).
...
*Note: For a character without Hand Tracking, the principle remains the same, but you can leave the pause settings on their default values.*
...
* **Interactive button:** Buttons that can be pressed interactively.
* **Viewport 2D and 3D:** Floating UI interfaces in VR space.
* **Grab Element:** Objects that can be grabbed and manipulated.
* **Snap Zone:** Magnetic zones to snap or store objects (e.g., spatial inventory).
